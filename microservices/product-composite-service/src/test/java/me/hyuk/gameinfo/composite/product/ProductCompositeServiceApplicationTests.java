package me.hyuk.gameinfo.composite.product;
...
import me.hyuk.gameinfo.composite.product.services.ProductCompositeIntegration;
...
class ProductCompositeServiceApplicationTests {
	...
	void setUp() {
		...
		when(compositeIntegration.getProduct(PRODUCT_ID_OK))
				.thenReturn(new Product(PRODUCT_ID_OK, "name", "genre", "mock-address"));
